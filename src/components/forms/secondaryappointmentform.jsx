...
export const SecondaryAppointmentForm = ({
    ...
    const onChangeCheckbox = (event, form_index) => {
        ...
        if (event.target.checked) {        
            temp_secondary_appointments_list[form_index]['related_vocation_ranks'][checkbox_rank].push(checkbox_vocation)
        } else {
            temp_secondary_appointments_list[form_index]['related_vocation_ranks'][checkbox_rank] = temp_secondary_appointments_list[form_index]['related_vocation_ranks'][checkbox_rank]
    ...
    const onAllRank = (event, form_index) => {
        ...
        if (event.target.checked) {
            temp_secondary_appointments_list[form_index]['related_vocation_ranks'][checkbox_rank] = cloneDeep(available_vocation_ranks[checkbox_rank])
        } else {
            temp_secondary_appointments_list[form_index]['related_vocation_ranks'][checkbox_rank] = []
        }
        set_secondary_appointments_list(temp_secondary_appointments_list)
        console.log(temp_secondary_appointments_list)
    }
