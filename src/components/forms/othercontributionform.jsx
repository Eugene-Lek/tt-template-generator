...
export const OtherContributionForm = ({
    ...
    const onChangeCheckbox = (event, form_index) => {
        ...
        if (event.target.checked) {        
            temp_other_contributions_list[form_index]['related_vocation_ranks'][checkbox_rank].push(checkbox_vocation)
        } else {
            temp_other_contributions_list[form_index]['related_vocation_ranks'][checkbox_rank] = temp_other_contributions_list[form_index]['related_vocation_ranks'][checkbox_rank]
    ...
    const onAllRank = (event, form_index) => {
        ...
        if (event.target.checked) {
            temp_other_contributions_list[form_index]['related_vocation_ranks'][checkbox_rank] = cloneDeep(available_vocation_ranks[checkbox_rank])
        } else {
            temp_other_contributions_list[form_index]['related_vocation_ranks'][checkbox_rank] = []
        }
        set_other_contributions_list(temp_other_contributions_list)
        console.log(temp_other_contributions_list)
    }
