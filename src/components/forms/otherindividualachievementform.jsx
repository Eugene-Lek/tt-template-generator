    ...
    const onChangeCheckbox = (event, index) => {
        ...
        if (event.target.checked) {
            ...
            if (!temp_other_individual_achievements_list[index]['related_vocation_ranks'][checkbox_vocation]){
                ...
                temp_other_individual_achievements_list[index]['related_vocation_ranks'][checkbox_vocation].push(checkbox_rank)
            }
        } else {
            temp_other_individual_achievements_list[index]['related_vocation_ranks'][checkbox_vocation] = temp_other_individual_achievements_list[index]['related_vocation_ranks'][checkbox_vocation]
