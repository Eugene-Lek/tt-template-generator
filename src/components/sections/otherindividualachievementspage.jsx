...
export function OtherIndividualAchievementsPage({ unit, section_name, available_vocation_ranks, set_dialog_settings }) {
    ...
    const onSelectByVocationRank = (option) => {
        ...
        let temp_other_individual_achievements_list = cloneDeep(other_individual_achievements_list)
        temp_other_individual_achievements_list.forEach(other_individual_achievement => {
            if (other_individual_achievement["related_vocation_ranks"][selected_rank]?.includes(selected_vocation) ||
                other_individual_achievement["previously_saved_related_vocation_ranks"][selected_rank]?.includes(selected_vocation)) {
                other_individual_achievement['display'] = 'block'
            }
            else {
    ...
    var previously_saved_vocation_ranks_without_templates = getVocationRanksWithMissingTemplates(available_vocation_ranks, other_individual_achievements_list, "previously_saved_related_vocation_ranks")
    ...
    available_other_individual_achievement_titles = [... new Set(available_other_individual_achievement_titles)]
