                ...
                <details>
                    ...
                    <div className="section-group">
                        ...
                        <div className="example-module">
                            ...
                            <div className="example-module-explanation">LTA ETHAN LOKE enlisted in the Singapore Armed Forces on 21 June 2021. Having displayed strong potential for military leadership during his Basic Military Training, he was selected to attend the Officer Cadet School where he underwent training to become a commissioned Army Officer. Upon commissioning, LTA LOKE was posted to 'A' Company, 30th Battalion, Singapore Combat Engineers (30SCE) to take on the contribution of Platoon Commander.</div>
                            <div className="example-module-explanation" style={{ fontWeight: 'bold' }}>2. 'Sword of Honour' Selected:</div>
                            <div className="example-module-explanation">LTA ETHAN LOKE enlisted in the Singapore Armed Forces on 21 June 2021. Having displayed strong potential for military leadership during his Basic Military Training, he was selected to attend the Officer Cadet School where he underwent training to become a commissioned Army Officer. To this end, LTA LOKE performed the best among his peers and graduated with a Sword of Honour (Top Performer). Upon commissioning, LTA LOKE was posted to 'A' Company, 30th Battalion, Singapore Combat Engineers (30SCE) to take on the contribution of Platoon Commander.</div>
                            <div className="example-module-explanation" style={{ fontWeight: 'bold' }}>3. 'Sword of Merit' Selected:</div>
                            <div className="example-module-explanation">LTA ETHAN LOKE enlisted in the Singapore Armed Forces on 21 June 2021. Having displayed strong potential for military leadership during his Basic Military Training, he was selected to attend the Officer Cadet School where he underwent training to become a commissioned Army Officer. To this end, LTA LOKE performed well and graduated with a Sword of Merit (Top 10%). Upon commissioning, LTA LOKE was posted to 'A' Company, 30th Battalion, Singapore Combat Engineers (30SCE) to take on the contribution of Platoon Commander.</div>
                        </div>
                    </div>
                </details>
                <details>
